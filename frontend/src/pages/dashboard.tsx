          ...
          <section className="flex-grow min-w-0">
            ...
            <div className="space-y-6">
              {activeTab === 'documents' && (
                <div className="space-y-6">
                  <ExerciseCard
                    title="Upload and extract content"
                    objective="Upload a file, then select it to view extracted text and AI analysis. Backend response is shown for each step."
                  ...
                  <ExerciseCard
                    title="Review extracted text and analysis"
                    objective="Open the selected document to see extracted text and AI analysis from the backend."
                    steps={['Select a document', 'Review extracted text', 'Refresh if needed']}
                    status={selectedDocument ? 'live' : 'not_configured'}
                    statusDetail={selectedDocument ? undefined : 'Select a document above to view results.'}
                  >
                    {selectedDocument ? (
                  ...
                  <ExerciseCard
                    title="Structured extraction (Invoice / Business Card)"
                    objective="Extract structured fields using Document Intelligence prebuilt models. Upload a file and view the backend response."
              ...
              {activeTab === 'vision' && (
                <div className="space-y-6">
                  <ExerciseCard
                    ...
                    objective="Upload an image, choose features (caption, tags, objects, OCR), and view the backend response."
                  ...
                  <ExerciseCard
                    title="Face detection, Video Indexer (not in this deployment)"
                    objective="These capabilities require additional Azure resources not provisioned in this deployment."
                    steps={[]}
              ...
              {activeTab === 'text-analytics' && (
                <div className="space-y-6">
                  <ExerciseCard
                    title="Analyze text"
                    objective="Language detection, sentiment, key phrases, and entities. Full backend response is shown."
                  ...
                  <ExerciseCard
                    ...
                    objective="Ask a question against your QnA knowledge base. Answer and backend response are shown."
                  ...
                  <ExerciseCard
                    title="Language Understanding (CLU)"
                    objective="Test intent recognition (Clock). Intent, entities, and full backend response are shown."
                  ...
                  <ExerciseCard
                    title="Translation, custom NER (not in this deployment)"
                    objective="These capabilities require additional Azure resources or training flows."
                    steps={[]}
                    status="not_supported"
                  >
                    <NotSupportedLab
              ...
              {activeTab === 'speech' && (
                <div className="space-y-6">
                  <ExerciseCard
                    ...
                    objective="Transcribe audio to text and synthesize speech. Backend response is shown for each action."
                  ...
                  <ExerciseCard
                    title="Speech translation (not in this deployment)"
                    objective="Speech translation requires additional configuration."
                    steps={[]}
                    status="not_supported"
                  >
                    <NotSupportedLab
              ...
              {activeTab === 'knowledge' && (
                <div className="space-y-6">
                  <ExerciseCard
                    title="Knowledge mining (search)"
                    objective="Query the Azure AI Search index. Matching documents and full backend response are shown."
              ...
              {activeTab === 'rag' && (
                <div className="space-y-6">
                  <ExerciseCard
                    title="RAG (ingest + ask)"
                    objective="Ingest documents and ask questions. Answer, sources, and full backend response are shown."
